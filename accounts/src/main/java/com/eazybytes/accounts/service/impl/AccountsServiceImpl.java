...
public class AccountsServiceImpl implements IAccountsService {
     ...
     */
    @Override
    public CustomerDto fetchAccountDetails(String mobilePhoneNumber) {
        Customer customer = customerRepository.findByMobileNumber(mobilePhoneNumber).orElseThrow(
                () -> new ResourceNotFoundException("Customer", "Mobile Number", mobilePhoneNumber)
        );
